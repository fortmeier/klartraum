#ifndef VULKAN_GAUSSIAN_SPLATTING_SOA_HPP
#define VULKAN_GAUSSIAN_SPLATTING_SOA_HPP
...
// Structure-of-Arrays variant of VulkanGaussianSplatting.
// Identical external interface — swap in place of VulkanGaussianSplatting.
// Uses SoA shaders (gsplat_*_soa.comp) for all stages; the three-pass
// binning pipeline and radix sort are otherwise unchanged.
class VulkanGaussianSplattingSoA : virtual public RenderGraphElement,
                                    virtual public ComputeGraphGroup {
public:
    VulkanGaussianSplattingSoA(
    ...
    virtual const char* getType() const override { return "GaussianSplattingSoA"; }
...
#endif // VULKAN_GAUSSIAN_SPLATTING_SOA_HPP
